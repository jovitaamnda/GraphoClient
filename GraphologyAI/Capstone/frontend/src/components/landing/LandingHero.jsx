...
export default function LandingHero() {
  ...
  return (
    <section className="relative bg-[#FFF8F4] text-[#221A13]">
      <div className="mx-auto max-w-full w-full px-8 py-20">
        <div className="space-y-12">
          <div className="max-w-5xl">
            <h1 className="text-6xl font-semibold tracking-tight leading-[1.1]">Selamat Datang,</h1>
            <p className="mt-6 max-w-3xl text-xl leading-relaxed text-[#524342]">Mulai perjalanan mengenal dirimu melalui analisis tulisan tangan dan kepribadian.</p>
          </div>
          ...
          <div className="grid gap-8 xl:grid-cols-[1.55fr_0.95fr]">
              ...
              <div className="grid min-h-full md:grid-cols-[1fr_1.1fr]">
                <div className="p-14 lg:p-20 flex flex-col justify-between">
                  ...
                  <button
                    ...
                    className="mt-12 inline-flex items-center justify-center rounded-full bg-[#C17F7C] px-12 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#C17F7C]/30 transition hover:bg-[#FEB4B0]"
                  >
                    Mulai Tes
                  </button>
                </div>
            ...
            <div className="rounded-[2rem] border border-[#DBC9C4] bg-white p-10 shadow-sm min-h-[580px]">
              <div className="flex items-center justify-between gap-4">
                <p className="text-[0.75rem] uppercase tracking-[0.42em] text-[#6E5B42] font-medium">Aktivitas Terbaru</p>
                <button onClick={() => router.push("/auth/login")} className="text-sm font-semibold text-[#854C4A] transition hover:text-[#C17F7C]">
                  Lihat Semua
                </button>
              </div>
              <p className="mt-6 text-sm leading-relaxed text-[#524342]">Mulai unggah tulisan tangan untuk melihat riwayat aktivitasmu di sini.</p>
              <div className="mt-10 rounded-[1.5rem] border border-[#F8E3DC] bg-[#FFF8F4] px-5 py-6 shadow-sm">
                <p className="text-sm font-semibold text-[#221A13]">Belum ada aktivitas</p>
                <p className="mt-2 text-xs text-[#6E5B42]">Unggah tulisan tanganmu dan dapatkan laporan pertamamu.</p>
              </div>
            </div>
          </div>
        </div>
